...
- Automated refactoring of source code (we generate policy, we don't rewrite the app)
- Runtime enforcement or policy-engine integration — zift is a static analysis tool
...
### Phase 2: Policy generation — Rego backend (1 week)
...
- We want first-class Policy-as-Code generation as part of the finding, not bolted on
...
### Licensing
Apache-2.0 — permissive, enterprise-friendly, compatible with OPA's and Cedar's licenses.
